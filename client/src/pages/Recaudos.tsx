...
import { ArrowDownLeft, CalendarDays, Check, ChevronDown, ChevronLeft, ChevronRight, Plus, Search, SlidersHorizontal, Tag, Upload, X, UserRound, Building2, AlertTriangle } from "lucide-react";
...
export default function Recaudos({ onNavigate }: { onNavigate: (section: string) => void }) {
  ...
  const schedule = () => {
    ...
    setSelectedPayer(null); setPayerQuery(""); setFormOpen(false); void 0;
  };
