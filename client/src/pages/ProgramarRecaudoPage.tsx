            ...
            <>
              ...
              <div className="detail-section-block detail-section-two-column">
                ...
                <div className="detail-fields-grid">
                  ...
                  <label className="detail-field" htmlFor="receipt-concept">Concepto <em>*</em><select id="receipt-concept" className="detail-select" value={concept} onChange={event => setConcept(event.target.value)}>{concepts.map(item => <option key={item.value} value={item.value}>{item.label}</option>)}</select><small>Ayuda a clasificar la operación en reportes.</small></label>
