...
describe("experiencia unificada de Bitaxus Global", () => {
  it("reúne la operación en una sola superficie sin paneles laterales", () => {
    expect(source).toContain('className="global-operation-shell"');
    expect(source).toContain("Operación internacional");
    expect(source).toContain("Define el par y el importe");
    expect(source).toContain('className="global-operation-grid"');
  ...
  it("consulta una tasa verificable y hace evidente el estado de actualización", () => {
    ...
    expect(source).toContain("Cotización de referencia");
    expect(source).toContain("Publicada el");
  ...
  it("permite calcular la conversión y confirmar con una ruta visual clara", () => {
    ...
    expect(source).toContain("Recibirás aproximadamente");
  ...
  it("persiste el par válido y conserva el selector buscable", () => {
    ...
    expect(styles).toContain(".global-operation-shell");
