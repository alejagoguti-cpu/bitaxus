    ...
    <section className="global-page">
      ...
      <div className="global-layout">
        ...
        <aside className="global-aside">
          <div className="quick-global panel"><h3>Acciones rápidas</h3><p className="quick-global-currency-note">Elige la moneda antes de registrar la operación.</p><button type="button" onClick={() => startQuickAction("Recepción")}><span className="quick-icon green"><ArrowDownLeft size={17} /></span><span><b>Recibir</b><small>Selecciona moneda y registra una recepción.</small></span><ChevronRight size={16} /></button><button type="button" onClick={() => startQuickAction("Conversión")}><span className="quick-icon coral"><ArrowLeftRight size={17} /></span><span><b>Convertir</b><small>Selecciona la moneda de origen para convertir.</small></span><ChevronRight size={16} /></button><button type="button" onClick={() => startQuickAction("Dispersión")}><span className="quick-icon green"><Send size={17} /></span><span><b>Dispersar</b><small>Selecciona moneda y registra fondos enviados.</small></span><ChevronRight size={16} /></button></div>
