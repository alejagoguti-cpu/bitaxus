...
export function DashboardPage({ tenantId }: DashboardPageProps) {
  ...
  const activity = useMemo<ActivityItem[]>(() => {
    ...
    return [...receiptItems, ...paymentItems].sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).slice(0, 8);
  }, [paymentRows, receiptRows]);
  ...
  return <main className="dashboard-page">
    <header className="dashboard-heading">
      <div><p className="eyebrow">Resumen operativo</p><h1>Dashboard</h1><p>Movimientos reales registrados en Supabase.</p></div>
